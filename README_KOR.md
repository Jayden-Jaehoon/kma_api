...
| 변수 | 설명 | 단위 | 출력 해상도 | 시작 연도 | 시간 집계 (원시 → 시간별) | 공간 집계 (격자 → 법정동) |
|------|------|------|-----------|-----------|-------------------------|------------------------|
| `ta` | 기온 | ℃ | 1시간 | 1997 | 5분 관측값의 평균 | 법정동 내 모든 격자 셀의 평균 |
| `rn_60m` | 60분 강수량 | mm | 1시간 | 1997 | 이미 60분 누적값 | 법정동 내 모든 격자 셀의 평균 |
| `sd_3hr` | 3시간 신적설 | cm | 3시간 | 2020 | 이미 3시간 누적값 (10월-5월만) | 법정동 내 모든 격자 셀의 평균 |
